import 'package:bovinoapp/data/response/status.dart';
import 'package:bovinoapp/res/style/text_style.dart';
import 'package:bovinoapp/view/home/up_coming_list/movie_list_item.dart';
        ...
        children: [
          ChangeNotifierProvider<HomeViewViewModel>(
              ...
              child: Consumer<HomeViewViewModel>(builder: (context, value, _) {
                switch (value.upComingList.status) {
                  case Status.LOADING:
                    return SizedBox(
                      height: height,
                  ...
                  case Status.ERROR:
                    return Text(value.upComingList.toString());
                  case Status.COMPLETED:
                    return Column(children: [
                      const HomeListTittleWidget(text: "Upcoming Film List"),
                      SizedBox(
                        height: height * .02,
                      ),
  ...
  SizedBox _upComingMovieList(double height, HomeViewViewModel value) {
    return SizedBox(
      ...
      child: ListView.builder(
          ...
          itemCount: value.upComingList.data!.results!.length,
